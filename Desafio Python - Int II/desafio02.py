...
# com base em três características: peso, textura (suave ou áspera) e 
# cor (vermelha, laranja ou amarela). Cada tipo de fruta tem limites específicos 
...
# Textura da fruta (suave ou áspera): uma string indicando se a fruta é suave 
# ("smooth") ou áspera ("rough").
# Cor da fruta (vermelha, laranja ou amarela): uma string indicando a cor da fruta.
# Saída
# O código deve produzir uma saída indicando a classificação da fruta com base 
